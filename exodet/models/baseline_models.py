"""
Baseline ML Models - ML Team
=============================

Traditional machine learning models for exoplanet detection.
This is the ACTUAL ML code - no more duplication!
"""
...
def train_baseline(df: pd.DataFrame, *, target_col: str = 'label', model_type: str = 'rf', output_path: str = None) -> TrainResult:
